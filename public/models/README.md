...
|---------------------|---------------------------------|-------------------------------|-------|
| `building.glb`      | `11-building-.rar` (Blender 2.79) | `heroBuilding`              | two towers; the rotated one faces +Z with its lobby at the origin, doorway cut in the glazing, ground plane / camera / sun removed, backface culling on |
